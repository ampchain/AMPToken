...
func (_Token *TokenCaller) FrozenAccount(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _Token.contract.Call(opts, out, "frozenAccount", arg0)
	return *ret0, err
}
...
//
// Solidity: function frozenAccount(address ) constant returns(bool)
func (_Token *TokenSession) FrozenAccount(arg0 common.Address) (bool, error) {
	return _Token.Contract.FrozenAccount(&_Token.CallOpts, arg0)
}

// FrozenAccount is a free data retrieval call binding the contract method 0xb414d4b6.
//
// Solidity: function frozenAccount(address ) constant returns(bool)
func (_Token *TokenCallerSession) FrozenAccount(arg0 common.Address) (bool, error) {
	return _Token.Contract.FrozenAccount(&_Token.CallOpts, arg0)
}
...
func (_Token *TokenTransactor) FreezeAccount(opts *bind.TransactOpts, target common.Address, freeze bool) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "freezeAccount", target, freeze)
}

// FreezeAccount is a paid mutator transaction binding the contract method 0xe724529c.
//
// Solidity: function freezeAccount(address target, bool freeze) returns()
func (_Token *TokenSession) FreezeAccount(target common.Address, freeze bool) (*types.Transaction, error) {
	return _Token.Contract.FreezeAccount(&_Token.TransactOpts, target, freeze)
}

// FreezeAccount is a paid mutator transaction binding the contract method 0xe724529c.
//
// Solidity: function freezeAccount(address target, bool freeze) returns()
func (_Token *TokenTransactorSession) FreezeAccount(target common.Address, freeze bool) (*types.Transaction, error) {
	return _Token.Contract.FreezeAccount(&_Token.TransactOpts, target, freeze)
}

// MintToke is a paid mutator transaction binding the contract method 0x2dfb5565.
//
// Solidity: function mintToke(address target, uint256 mintedAmount) returns()
func (_Token *TokenTransactor) MintToke(opts *bind.TransactOpts, target common.Address, mintedAmount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "mintToke", target, mintedAmount)
}

// MintToke is a paid mutator transaction binding the contract method 0x2dfb5565.
//
// Solidity: function mintToke(address target, uint256 mintedAmount) returns()
func (_Token *TokenSession) MintToke(target common.Address, mintedAmount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.MintToke(&_Token.TransactOpts, target, mintedAmount)
}

// MintToke is a paid mutator transaction binding the contract method 0x2dfb5565.
//
// Solidity: function mintToke(address target, uint256 mintedAmount) returns()
func (_Token *TokenTransactorSession) MintToke(target common.Address, mintedAmount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.MintToke(&_Token.TransactOpts, target, mintedAmount)
}
...
// TokenFrozenFundsIterator is returned from FilterFrozenFunds and is used to iterate over the raw logs and unpacked data for FrozenFunds events raised by the Token contract.
type TokenFrozenFundsIterator struct {
	Event *TokenFrozenFunds // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenFrozenFundsIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenFrozenFundsIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenFrozenFundsIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenFrozenFunds represents a FrozenFunds event raised by the Token contract.
type TokenFrozenFunds struct {
...
//
// Solidity: event FrozenFunds(address target, bool frozen)
func (_Token *TokenFilterer) FilterFrozenFunds(opts *bind.FilterOpts) (*TokenFrozenFundsIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "FrozenFunds")
	if err != nil {
		return nil, err
	}
	return &TokenFrozenFundsIterator{contract: _Token.contract, event: "FrozenFunds", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event FrozenFunds(address target, bool frozen)
func (_Token *TokenFilterer) WatchFrozenFunds(opts *bind.WatchOpts, sink chan<- *TokenFrozenFunds) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "FrozenFunds")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenFrozenFunds)
				if err := _Token.contract.UnpackLog(event, "FrozenFunds", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFrozenFunds is a log parse operation binding the contract event 0x48335238b4855f35377ed80f164e8c6f3c366e54ac00b96a6402d4a9814a03a5.
//
// Solidity: event FrozenFunds(address target, bool frozen)
func (_Token *TokenFilterer) ParseFrozenFunds(log types.Log) (*TokenFrozenFunds, error) {
	event := new(TokenFrozenFunds)
	if err := _Token.contract.UnpackLog(event, "FrozenFunds", log); err != nil {
		return nil, err
	}
